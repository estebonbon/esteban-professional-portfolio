...
export const HERO_CONTENT = `My name is Esteban, a self-driven front-end developer who’s spent countless hours mastering the fine art of Google search (and, of course, web development). I’m passionate about continuous learning and building projects that make an impact. Now, I’m eager to join a dynamic team where I can contribute, grow, and help tackle the exciting chaos of one of the world’s fastest-evolving fields.`;
